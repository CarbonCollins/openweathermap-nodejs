...
const WeatherMixin = (SuperClass) => { 
  ...
  const Weather = class extends SuperClass {
     ...
     * @param {String} [options.units] default uses kelvin, can also specify 'metric' for centegrade and 'imprerial' for Fahrenheit.   
     */
    constructor(options = {}) {
      super(options);
     ...
     * @desc gets a forecast for the next 5 days in 3 hour intervals
     * @public
     ...
     * @desc gets a daily forecast for up to 16 days in the future (paid accounts only)
     * @public
